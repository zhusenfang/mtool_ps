...
import com.mtool.MainActivity;
import com.mtool.MyApplication;
import com.mtool.R;
import com.mtool.chat.activity.VoiceCallActivity;
import com.mtool.chat.db.DemoDBManager;
import com.mtool.chat.db.InviteMessgeDao;
import com.mtool.chat.domain.EaseEmojicon;
import com.mtool.chat.domain.EaseEmojiconGroupEntity;
import com.mtool.chat.domain.EaseUser;
import com.mtool.chat.domain.EmojiconExampleGroupData;
import com.mtool.chat.domain.GroupChatExtBean;
import com.mtool.chat.domain.InviteMessage;
import com.mtool.chat.model.DemoModel;
import com.mtool.chat.model.EaseNotifier;
import com.mtool.chat.receiver.CallReceiver;
import com.mtool.chat.util.EaseCommonUtils;
import com.mtool.chat.util.PreferenceManager;
...
import static com.mtool.util.ToastUtils.showToast;
...
//                } else
                if (isVoiceCalling) {
                    ...
                    if (chatType == EMMessage.ChatType.Chat) { // single chat searchMessage
                        ...
                        String expressageOrderId = message.getStringAttribute("expressageOrderId", "");
                        intent.putExtra("orderId",expressageOrderId);
...
//                    !easeUI.hasForegroundActivies() &&
                    if (!message.getFrom().equals(getCurrentUsernName())) {
