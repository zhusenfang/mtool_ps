...
//                notificationManager.cancel(foregroundNotifyID);
    ...
    public interface EaseNotificationInfoProvider {
        /**
         * set the notification message, such as "you received a new image from xxx"
         *
         * @param message
        ...
        /**
         * set the notification message: such as "you received 5 message from 2 contacts"
         *
         * @param message
