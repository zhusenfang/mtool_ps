...
import com.mtool.chat.domain.ConversationExtBean;
import com.mtool.chat.domain.GroupChatExtBean;
import com.mtool.chat.util.EaseCommonUtils;
import com.mtool.chat.util.EaseSmileUtils;
import com.mtool.util.EaseUserUtils;
import com.mtool.util.Json_U;

import java.util.Date;
import java.util.List;

import static com.mtool.MyApplication.getContext;
...
public class ConversationAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(MyApplication.getContext()).inflate(R.layout.ease_row_chat_history, parent, false);
        }
